...
const translations = {
  ...
  es: {
    ...
    about_lead:         'Soy estudiante de DAM con especialización en IA y Big Data, apasionado por construir sistemas que procesan información de forma inteligente y generan valor real.',
    about_body:         'Mi trabajo combina el rigor del desarrollo backend con la curiosidad por los modelos de lenguaje, la visión artificial y el análisis de datos a gran escala. Busco mi primera oportunidad en un equipo donde seguir creciendo y aportar desde el primer día.',
    about_location:     'Ubicación',
    about_edu:          'Formación',
    about_edu_val:      'DAM · Especialización IA & Big Data',
    about_lang:         'Idiomas',
  ...
  en: {
    ...
    about_lead:         'I\'m a DAM student specialising in AI and Big Data, passionate about building intelligent systems that process information and generate real value.',
    about_body:         'My work blends backend rigour with curiosity for language models, computer vision, and large-scale data analysis. I\'m looking for my first opportunity in a team where I can keep growing and contribute from day one.',
    about_location:     'Location',
    about_edu:          'Education',
    about_edu_val:      'DAM · AI & Big Data specialisation',
